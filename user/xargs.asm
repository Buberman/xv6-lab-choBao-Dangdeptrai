...
int main(int argc, char *argv[]) {
  ...
  1c:	0d00                	addi	s0,sp,656
    char buf[512];
    char *cmd[MAXARGS + 2]; // Additional space for command and NULL terminator
    int n, i;

    if (argc < 2) {
  1e:	4785                	li	a5,1
  20:	00a7dd63          	bge	a5,a0,3a <main+0x3a>
    ...
    cmd[0] = argv[1];
  24:	659c                	ld	a5,8(a1)
  26:	d6f43823          	sd	a5,-656(s0)

    // Read from stdin until EOF
    while ((n = read(0, buf, sizeof(buf))) > 0) {
  2a:	dd040493          	addi	s1,s0,-560
        int start = 0;
        int argc = 1; // Start with 1 for the command itself
  2e:	4a05                	li	s4,1
  30:	4905                	li	s2,1
  32:	4099093b          	subw	s2,s2,s1
        for (i = 0; i < n; i++) {
            if (buf[i] == '\n') {
                buf[i] = '\0'; // Replace newline with null terminator
                cmd[argc++] = &buf[start]; // Set argument to the line read
                start = i + 1;
                if (argc >= MAXARGS) {
  36:	49a5                	li	s3,9
    while ((n = read(0, buf, sizeof(buf))) > 0) {
  ...
  3e:	8b658593          	addi	a1,a1,-1866 # 8f0 <malloc+0xe6>
  42:	4509                	li	a0,2
  44:	00000097          	auipc	ra,0x0
  48:	6da080e7          	jalr	1754(ra) # 71e <fprintf>
        exit(1);
  4c:	4505                	li	a0,1
  4e:	00000097          	auipc	ra,0x0
  52:	386080e7          	jalr	902(ra) # 3d4 <exit>
                    fprintf(2, "xargs: too many arguments\n");
  56:	00001597          	auipc	a1,0x1
  5a:	8ba58593          	addi	a1,a1,-1862 # 910 <malloc+0x106>
  5e:	4509                	li	a0,2
  60:	00000097          	auipc	ra,0x0
  64:	6be080e7          	jalr	1726(ra) # 71e <fprintf>
                    exit(1);
  68:	4505                	li	a0,1
  6a:	00000097          	auipc	ra,0x0
  6e:	36a080e7          	jalr	874(ra) # 3d4 <exit>
        for (i = 0; i < n; i++) {
  72:	0785                	addi	a5,a5,1
  74:	02c78763          	beq	a5,a2,a2 <main+0xa2>
            if (buf[i] == '\n') {
  78:	0007c683          	lbu	a3,0(a5)
  7c:	fea69be3          	bne	a3,a0,72 <main+0x72>
                buf[i] = '\0'; // Replace newline with null terminator
  80:	00078023          	sb	zero,0(a5)
                cmd[argc++] = &buf[start]; // Set argument to the line read
  84:	0017069b          	addiw	a3,a4,1
  88:	070e                	slli	a4,a4,0x3
  8a:	fd040813          	addi	a6,s0,-48
  8e:	9742                	add	a4,a4,a6
  90:	95a6                	add	a1,a1,s1
  92:	dab73023          	sd	a1,-608(a4)
                start = i + 1;
  96:	00f905bb          	addw	a1,s2,a5
                if (argc >= MAXARGS) {
  9a:	fad9cee3          	blt	s3,a3,56 <main+0x56>
                cmd[argc++] = &buf[start]; // Set argument to the line read
  9e:	8736                	mv	a4,a3
  a0:	bfc9                	j	72 <main+0x72>
                }
            }
        }
        cmd[argc] = 0; // Null-terminate the argument list
  a2:	070e                	slli	a4,a4,0x3
  a4:	fd040793          	addi	a5,s0,-48
  a8:	973e                	add	a4,a4,a5
  aa:	da073023          	sd	zero,-608(a4)
        int pid = fork();
  ae:	00000097          	auipc	ra,0x0
  b2:	31e080e7          	jalr	798(ra) # 3cc <fork>
        if (pid < 0) {
  b6:	02054e63          	bltz	a0,f2 <main+0xf2>
            fprintf(2, "xargs: fork failed\n");
            exit(1);
        } else if (pid == 0) {
  ba:	c931                	beqz	a0,10e <main+0x10e>
            exec(cmd[0], cmd + 1); // Execute the command with its arguments
  ...
  c2:	31e080e7          	jalr	798(ra) # 3dc <wait>
    while ((n = read(0, buf, sizeof(buf))) > 0) {
  c6:	20000613          	li	a2,512
  ca:	85a6                	mv	a1,s1
  cc:	4501                	li	a0,0
  ce:	00000097          	auipc	ra,0x0
  d2:	31e080e7          	jalr	798(ra) # 3ec <read>
  d6:	06a05263          	blez	a0,13a <main+0x13a>
  da:	fff5061b          	addiw	a2,a0,-1
  de:	1602                	slli	a2,a2,0x20
  e0:	9201                	srli	a2,a2,0x20
  e2:	dd140793          	addi	a5,s0,-559
  e6:	963e                	add	a2,a2,a5
  e8:	87a6                	mv	a5,s1
        int argc = 1; // Start with 1 for the command itself
  ea:	8752                	mv	a4,s4
        int start = 0;
  ec:	4581                	li	a1,0
            if (buf[i] == '\n') {
  ee:	4529                	li	a0,10
  f0:	b761                	j	78 <main+0x78>
            fprintf(2, "xargs: fork failed\n");
  f2:	00001597          	auipc	a1,0x1
  f6:	83e58593          	addi	a1,a1,-1986 # 930 <malloc+0x126>
  fa:	4509                	li	a0,2
  fc:	00000097          	auipc	ra,0x0
 100:	622080e7          	jalr	1570(ra) # 71e <fprintf>
            exit(1);
 104:	4505                	li	a0,1
 106:	00000097          	auipc	ra,0x0
 10a:	2ce080e7          	jalr	718(ra) # 3d4 <exit>
            exec(cmd[0], cmd + 1); // Execute the command with its arguments
 10e:	d7840593          	addi	a1,s0,-648
 112:	d7043503          	ld	a0,-656(s0)
 116:	00000097          	auipc	ra,0x0
 11a:	2f6080e7          	jalr	758(ra) # 40c <exec>
            fprintf(2, "xargs: exec failed\n");
 11e:	00001597          	auipc	a1,0x1
 122:	82a58593          	addi	a1,a1,-2006 # 948 <malloc+0x13e>
 126:	4509                	li	a0,2
 128:	00000097          	auipc	ra,0x0
 12c:	5f6080e7          	jalr	1526(ra) # 71e <fprintf>
            exit(1);
 130:	4505                	li	a0,1
 ...
 140:	298080e7          	jalr	664(ra) # 3d4 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4bc:	4b050513          	addi	a0,a0,1200 # 968 <digits>
 4c0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 588:	3e4b8b93          	addi	s7,s7,996 # 968 <digits>
 ...
 6c8:	29c90913          	addi	s2,s2,668 # 960 <malloc+0x156>
        while(*s != 0){
