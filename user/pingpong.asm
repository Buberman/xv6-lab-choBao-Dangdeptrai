...
int main(){
  ...
  10:	360080e7          	jalr	864(ra) # 36c <pipe>

    if (fork() ==0){
  14:	00000097          	auipc	ra,0x0
  18:	340080e7          	jalr	832(ra) # 354 <fork>
  1c:	e921                	bnez	a0,6c <main+0x6c>
        close(p[1]);
  1e:	fec42503          	lw	a0,-20(s0)
  22:	00000097          	auipc	ra,0x0
  26:	362080e7          	jalr	866(ra) # 384 <close>
        char buf;
        read(p[0], &buf,1);
  2a:	4605                	li	a2,1
  2c:	fe740593          	addi	a1,s0,-25
  30:	fe842503          	lw	a0,-24(s0)
  34:	00000097          	auipc	ra,0x0
  38:	340080e7          	jalr	832(ra) # 374 <read>
        printf("%d: received ping\n",getpid());
  3c:	00000097          	auipc	ra,0x0
  40:	3a0080e7          	jalr	928(ra) # 3dc <getpid>
  44:	85aa                	mv	a1,a0
  46:	00001517          	auipc	a0,0x1
  4a:	83a50513          	addi	a0,a0,-1990 # 880 <malloc+0xee>
  4e:	00000097          	auipc	ra,0x0
  52:	686080e7          	jalr	1670(ra) # 6d4 <printf>
        close(p[0]);
  56:	fe842503          	lw	a0,-24(s0)
  5a:	00000097          	auipc	ra,0x0
  5e:	32a080e7          	jalr	810(ra) # 384 <close>
        exit(0);
  62:	4501                	li	a0,0
  64:	00000097          	auipc	ra,0x0
  68:	2f8080e7          	jalr	760(ra) # 35c <exit>
    }
    else {
        close(p[0]);
  6c:	fe842503          	lw	a0,-24(s0)
  70:	00000097          	auipc	ra,0x0
  74:	314080e7          	jalr	788(ra) # 384 <close>
        char ping = 'p';
  78:	07000793          	li	a5,112
  7c:	fef403a3          	sb	a5,-25(s0)
        write(p[1],&ping,1);
  80:	4605                	li	a2,1
  82:	fe740593          	addi	a1,s0,-25
  86:	fec42503          	lw	a0,-20(s0)
  8a:	00000097          	auipc	ra,0x0
  8e:	2f2080e7          	jalr	754(ra) # 37c <write>
        close(p[1]);
  92:	fec42503          	lw	a0,-20(s0)
  96:	00000097          	auipc	ra,0x0
  9a:	2ee080e7          	jalr	750(ra) # 384 <close>
        wait(0);
  9e:	4501                	li	a0,0
  a0:	00000097          	auipc	ra,0x0
  a4:	2c4080e7          	jalr	708(ra) # 364 <wait>
        printf("%d: received pong\n",getpid());
  a8:	00000097          	auipc	ra,0x0
  ac:	334080e7          	jalr	820(ra) # 3dc <getpid>
  b0:	85aa                	mv	a1,a0
  b2:	00000517          	auipc	a0,0x0
  b6:	7e650513          	addi	a0,a0,2022 # 898 <malloc+0x106>
  ba:	00000097          	auipc	ra,0x0
  be:	61a080e7          	jalr	1562(ra) # 6d4 <printf>
        exit(0);
  c2:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 444:	47850513          	addi	a0,a0,1144 # 8b8 <digits>
 448:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 650:	26490913          	addi	s2,s2,612 # 8b0 <malloc+0x11e>
        while(*s != 0){
